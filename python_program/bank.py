...
match choice:
	...
	case 2:
		print("Your selected bank is :- North East")
		print("1. North East - 1Y 5M - 8.75%")
		print("2. North East - 3Y - 9%")
	...
	case 3:
		print("Your selected bank is :- Shivalik")
		print("1. Shivalik - 1Y 6M - 8.30%")
		tenure_choice = int(input("Enter your choice : "))
	...
	case 4:
		print("Your selected bank is :- Utkarsh")
		print("1. Utkarsh - 4Y 40D - 8.50%")
		tenure_choice = int(input("Enter your choice : "))
